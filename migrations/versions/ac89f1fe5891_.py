...
Revision ID: ac89f1fe5891
Revises: 
Create Date: 2023-08-08 16:01:32.356311
...
def upgrade():
    ...
    sa.Column('genres', sa.ARRAY(sa.String(length=255), dimensions=1), nullable=True),
